...
$datos=mostrardatosDeducciones($myString,$mes);
$num=count($datos);
...
$pdf->SetFont('Arial','B',6);
  ...
  $pdf->Cell(87, 6, 'Monto', 0, 1, 'R', false);
  $pdf->Cell(125, -6, 'Descripcion', 0, 1, 'R', false);
  $pdf->Cell(135, 6, 'Planilla', 0, 1, 'R', false);
  $pdf->Cell(155, -6, 'Fecha Ingresos', 0, 1, 'R', false);
  $pdf->Cell(175, 6, 'Fecha Procesada', 0, 1, 'R', false);
...
for($i=0;$i<$num;$i++){
  ...
  $pdf->Ln(2);
  $pdf->Cell(87, -3, $datos[$i]['ndedamt'], 0, 1, 'R', false);
  $pdf->Ln(2);
  $pdf->Cell(125, -2, $datos[$i]['cdesc'], 0, 1, 'R', false);
  $pdf->Ln(2);
  $pdf->Cell(135, -2, trim($datos[$i]['cplnid']), 0, 1, 'R', false);
  $pdf->Ln(2);
  $pdf->Cell(155, -2, trim($datos[$i]['ttrndate']), 0, 1, 'R', false);
  $pdf->Ln(2);
...
$pdf->Ln(5);  
$pdf->Cell(170, 4, 'Total: '.number_format($datos['Total'],2), 0, 1, 'R', false);
