...
return $row;
 ...
 function mostrardatos($mes,$opcion,$opcionMes){
  ...
  if ($opcion==0) {
    ...
    from prmisd a, prempy b where a.cempno=b.cempno and YEAR(tmodrec)='$anio' and MONTH(tmodrec)='$meses'  and a.cdedcode IN('915') order by a.tmodrec");
  }else{
    $sql=mssql_query("SELECT  a.cempno,b.clname, b.cfname,b.ctaxstate, cdeptno,a.cpayno,cfedid, a.cdedcode, a.cdesc, a.ndedamt,cplnid, a.tmodrec
    from prmisd a, prempy b where a.cempno=b.cempno and cpayno='$mes' and a.cdedcode IN('915') order by a.tmodrec");
  }
