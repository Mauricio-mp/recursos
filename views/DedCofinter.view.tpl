    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=DedCofinter&x=1">


                            <div class="card">
                                <div class="card-header">
                                    <strong>Deducciones De COFINTER </strong>
        ...
        <script>
            function MyFunction(opcion) {
                location.href = './Pdf/ReporteCofinter.php?mes=' + opcion;
            }

            function excel(mes) {
                location.href = 'index.php?page=DedCofinter&x=2';
            }
