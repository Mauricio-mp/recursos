    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=Impuestos&x=1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Seleciones Planilla</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="text-input" class=" form-control-label">Filtrar por Sueldo</label></div>
                                        <div id="boxtext">
                                            <label class="switch">
                                    ...
                                    <div class="row form-group ">
                                        ...
                                        <div class="col-12 col-md-9 "><input type="number" name="sueldo" id="sueldo" class="form-control" disabled></div>
                                    </div>
                                ...
                                <div style="text-align:left ">
                                    ...
                                    {{if valores}}
                                    <div style="text-align: center; ">
                                        <button type="button " onclick="MyFunction( '{{opcion}}') " class="btn btn-success "><i class="fa fa-print "></i>&nbsp; Pdf</button> &nbsp;
        ...
        <script>
            function MyFunction(opcion) {
                location.href = './Pdf/ReporteComemp.php?mes=' + opcion;
            }

            function excel(mes) {
                location.href = 'index.php?page=DedCOMEMP&x=2&y=' + mes;
            }
