        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div align="center">
                    ...
                    <form method="POST" id="form_fecha">


                        <div class="row form-group">
                            <p>Fecha inicio</p>
                            <div class="col col-sm-4"> <input type="date" value="1994-01-01" id="Inicio" name="Inicio" placeholder=".col-sm-4" class="form-control"></div>
                        </div>
                        <br></br>
                        <div class="row form-group">
                            <p>Fecha Final</p>
                            <div class="col col-sm-4"><input type="date" value="{{fecha}}" name="Final" id="Final" placeholder=".col-sm-4" class="form-control"></div>
                        </div>
                        <br></br>
                        <div>
                            <button type="submit" id="BtnApectar" name="BtnApectar" class="btn btn-outline-primary btn-lg btn-block">Aceptar</button>
                        </div>
