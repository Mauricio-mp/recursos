    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=DedTrab&x=1">


                            <div class="card">
                                <div class="card-header">
                                    <strong>Deducciones Banco de los Trabajadores </strong>
        ...
        <script>
            function MyFunction(opcion) {
                location.href = './Pdf/ReporteTrab.php?mes=' + opcion;
            }

            function excel(mes) {
                location.href = 'index.php?page=DedTrab&x=2&y=' + mes;
            }
