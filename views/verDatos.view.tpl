...
<body class="fondo">
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card>
                                    <form method=" post " action="index.php?page=fechas ">
                                        <div class="row form-group ">
                                                              <table>
                                                                  {{foreach Datos}}   
                                                      <tr>
                                                          <td style="font-size:20px " width="5% "> <strong>Nombre:</strong></td>   
                                                          <td style="font-size:20px " width="40% ">{{cfname}}</td>  
                                                          <td style="font-size:20px "  width="5% "> <strong>Identidad:</strong></td>  
                                                          <td style="font-size:20px " width="40% "> {{cfedid}}</td>        
                                                     </tr>
                                                     <tr>
                                                    ...
                                                    <tr>
                                                          ...
                                                          <td style="font-size:20px " width="5% " > <strong> Codigo Empleado:</strong></td>   
                                                          <td style="font-size:20px " width="5% ">{{cempno}}</td> 
                                                          <td style="font-size:20px " width="20% "> <strong>Fecha Contrato:</strong></td>   
                                                          <td style="font-size:20px " width="5% ">{{dhire}}</td>
                                                    </tr>
                                                    <tr>
                                                         <td style="padding-top:30px "></td>
                                                    </tr>
                                                      <tr>
                                                          <td style="font-size:20px " width="15% "> <strong>Fecha Acuerdo:</strong></td>   
                                                          <td style="font-size:20px "  width="5% ">{{dcntrct}}</td>  
                                                          <td style="font-size:20px "  width="20% " > <strong>Fecha Finalizado:</strong></td>   
                                                          <td style="font-size:20px "  width="5% ">{{dterminate}}</td>    
                                                    ...
                                                    <tr>
                                                         <td style="font-size:20px " width="15% "> <strong>Sueldo Actual:</strong></td>   
                                                          <td style="font-size:20px "  width="5% ">L. {{nmonthpay}}</td>  
                                                    </tr>
                                                     <tr>
                                                         <td style="padding-top:30px "></td>
                                                    </tr>
                                                    ...
                                                    {{endfor Datos}} 
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td style="font-size:20px "  width="20% " > <strong>Cargo Actual</strong></td>   
                                                          <td style="font-size:20px "  width="5% "> {{cDesc}}</td>    
                                                     ...
                                                     {{endfor cargo}}
                                                       <tr>
                                                          {{foreach depto}}
                                                          <td style="font-size:20px " width="15% "> <strong>Dependencia:</strong></td>   
                                                          <td style="font-size:20px "  width="5% ">{{cdeptname}}</td>  
                                                           {{endfor depto}}
                                          ...
                                          <div style="text-align: center " id="btnPDF" >
                   
                                            <a class="btn btn-info " href="# " onclick="guardarPdf( '{{Cod}}', '{{fechaInicio}}', '{{fechaFin}}', '{{codigo}}') " >Imprimir Pdf</a>
                                        </div>
                                ...
                                <table id="bootstrap-data-table " class="table table-striped table-bordered ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Cuenta</th>
                                            <th>Valor</th>
                                            <th class="hidden-480 ">Transaccion</th>
                                        </tr>
                                    </thead>
      ...
      toasterOptions();
            ...
            function guardarPdf(codigo,fechaInicio,FechaFin,usuarioLogueado){
                document.getElementById("btnPDF").style.display = "none";
            
                $('#gif').html('<div alt="logo" class="loading"><img src="img/gif.gif" alt="loading" /><br/>Espere, Esto puede tardar varios minutos...</div>');
