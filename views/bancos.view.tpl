    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=bancos&x=1">


                            <div class="card">
                                <div class="card-header">
                                    <strong>reporte de bancos </strong>

                                </div>
                                <div class="card-body">

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomina</label></div>
                                        <div class="col-12 col-md-9"><select data-placeholder="ingrese Nomina" id="Nomina" name="nomina" class="standardSelect" tabindex="1">
                                            {{foreach Planillas}}
                                   ...
                                   {{endfor Planillas}}
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cotrato/Acuerdo</label></div>
                                        <div class="col-12 col-md-9"><select data-placeholder="seleccione tipo" id="Tipo" name="tipo" class="standardSelect" tabindex="1">
                                           <option value="C" selected>Contrato</option>
                                    ...
                                    <div class="card-body">
                                        <div class="row form-group">
                                            ...
                                            <div style="text-align: left;">
                                                ...
                                                <button type="button" onclick="excel('{{nomina}}','{{tipo}}')" class="btn btn-success"><i class="fa fa-table"></i>&nbsp; EXCEL</button>&nbsp;
                                                <button type="button" onclick="excelPlanillas('{{nomina}}','{{tipo}}')" class="btn btn-danger"><i class="fa fa-table"></i>&nbsp; EXCEL</button>
                                            </div>
            ...
            <script>
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var count = Object.keys(json.mensaje).length;
                        console.warn(json);
                        for (var index = 0; index < count; index++) {
                            daySelect = document.getElementById('Nomina');
                            document.getElementById("Nomina").style.display = "block";


                            myOption = document.createElement("option");
                            myOption.text = json.mensaje[index]['cpayno'];
                            myOption.value = json.mensaje[index]['cpayno'];
                ...
                function MyFunction() {
                    ...
                    var link = "index.php?page=bancos&x=4";
                ...
                function excel(nomina, tipo) {
                    location.href = 'index.php?page=bancos&x=4&nomina=' + nomina + '&tipo=' + tipo;


                }
                function excelPlanillas(nomina, tipo){
                    location.href = 'index.php?page=bancos&x=3&nomina=' + nomina + '&tipo=' + tipo;
