    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=fechas&fec={{CodigoEmpleado}}">
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Fecha Inicio</label></div>
                                <div class="col-12 col-md-9"><input type="date" id="text-input" value="1994-01-01" name="FechaInicio" id="FechaInicio" placeholder="Text" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Fecha Final</label></div>
                                <div class="col-12 col-md-9"><input type="date" value="{{fechas}}" id="text-input" name="FechaFinal" id="FechaFinal" placeholder="Text" class="form-control"><small class="form-text text-muted"></small></div>
                            </div>
                            ...
                            <div style="text-align: center">
                                <button type="submit" class="btn btn-primary btn-lg" name="btnAceptar" id="btnAceptar">Aceptar</button>
