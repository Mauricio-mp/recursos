    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=DedInjupemp&x=1">


                            <div class="card">
                                <div class="card-header">
                                    <strong>Deducciones de INJUPEMP </strong>
        ...
        <script>
            function MyFunction(opcion) {
                location.href = './Pdf/ReporteInjupemp.php?mes=' + opcion;
            }

            function excel(mes) {
                location.href = 'index.php?page=DedInjupemp&x=2';
            }
