    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=General&x=1">


                            <div class="card">
                                <div class="card-header">
                                    <strong>Deducciones Por Planilla </strong>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" class="form-control" placeholder="Ingrese Codigo de Empleado" name="txtnombre"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre</label></div>
                                        <div class="col-12 col-md-9"><select data-placeholder="ingrese nombre" name="nombre" class="standardSelect" tabindex="1">
                                            {{foreach Nombre}}
                                            <option value="{{cempno}}" >{{nombre}}</option>
                                           {{endfor Nombre}}
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <select name="CbxDepartamento" data-placeholder="Seleccione Departamentos" class="standardSelect">
                                        {{foreach departamentos}}
                                        <option value="{{cdeptno}}">({{cdeptname}}) </option>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Puesto</label></div>
                                        <div class="col-12 col-md-9"><select data-placeholder="Seleccione Puesto" name="puesto" class="standardSelect" tabindex="1">
                                            {{foreach puesto}}
                                            <option value="{{cJobTitlNO}}" >{{cDesc}}</option>
                                           {{endfor puesto}}
                                           <option selected></option>
                                        </select></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><select data-placeholder="Seleccione Estado" name="estado" class="standardSelect" tabindex="1">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Region de impuesto</label></div>
                                        <div class="col-12 col-md-9"><select data-placeholder="Seleccione Region de impuesto" name="region" class="standardSelect" tabindex="1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Fecha Contrato</label><input type="date" name="FechaInicialContrato" placeholder="Jane Doe" class="form-control"></div>
                                        &nbsp;
                                        <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Fecha Acuerdo</label><input type="date" name="FechaInicialAcuerdo" placeholder="Jane Doe" class="form-control"></div>


                                    </div>
 Rango de Sueldos: <input type="checkbox" id="myCheck" name="myCheck" onclick="chkfunction()">

                                        
                                </div>


                                   <div class="card"  id="divrangos" style="display:none">

                                <div class="card-body">

                                    <div class="row form-group">

                                        <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Desde</label><input type="number" id="SueldoInicial" name="SueldoInicial" placeholder="Sueldo Inicial" class="form-control"></div>
                                        &nbsp;
                                        <div class="form-group"><label for="exampleInputName2" class="pr-1  form-control-label">Hasta</label><input type="number" id="SueldoFinal" name="SueldoFinal" placeholder="Sueldo Final" class="form-control"></div>
            ...
            <script>
                ...
                function MyFunction() {
                    ...
                    var link = "http://192.168.127.131/recursos/Pdf/ReporteGeneral.php";
                ...
                function excel(mes) {
                    location.href = 'index.php?page=General&x=4';
                }

                function deducciones() {

                    var deducciones = $('#CbxDeduccion').val();
  ...
  var text = document.getElementById("divrangos");
