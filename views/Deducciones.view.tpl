    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                ...
                <div class="">
                    <div>
                        <form method="post" action="index.php?page=Deducciones&x=2">
                            ...
                            <div class="card">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Deducción</label></div>
                                        <div class="col-12 col-md-9"> <select name="CbxDeduccion[]" data-placeholder="Seleccione deducciones" multiple class="standardSelect">
                                        {{foreach Deducciones}}
                                        <option value="{{cdedcode}}">{{cdedcode}} ({{cdescript}}) </option>
                                        {{endfor Deducciones}}
                                    </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <input type="text" class="form-control" name="IngresoPlanilla" >
                                        </div>
                                    </div>
                                ...
                                <div style="text-align:left">
                                    ...
                                    <div style="text-align: left;">
                                        ...
                                        <button type="button" onclick="excel('{{mes}}')" class="btn btn-success"><i class="fa fa-table"></i>&nbsp; EXCEL</button>
                                    </div>
        ...
        <script>
            ...
            function MyFunction() {
                ...
                var link = "http://172.17.0.254/recursos/Pdf/ReporteDeducciones.php";
            ...
            function excel(mes) {
                location.href = 'index.php?page=Deducciones&x=4';
            }
