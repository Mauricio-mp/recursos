    ...
    <div id="right-panel" class="right-panel">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Codigo deduccion:</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="Codigo" id="Codigo" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Planilla</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="Planilla" id="Planilla" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">SEleciones Mes</label></div>
                                        <div class="col-12 col-md-9"><select class="form-control">
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <button id="BtnAceptar" type="button" class="btn btn-primary btn-lg btn-block">Primary</button>
        ...
        <script>
            $("#BtnAceptar").click(function() {
                ...
                $.post("index.php?page=DedPlanilla&x=1", {
                    Codigo: Codigo,
                    Planilla: Planilla
                }, function(response) {
