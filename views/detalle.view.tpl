...
<body class="fondo">
    ...
    <!-- /#left-panel -->
    <!-- Right Panel -->
    <div id="right-panel" class="right-panel" " > <!-- fondo principal-->
        <!-- Header-->
       ...
       <div class="content " >
            ...
            <div class="animated fadeIn " style="background-repeat: #FFF ">
                 ...
                 <div align="center " >
                  ...
                  <div class="container ">
                   ...
                   <thead>
                       <tr>
                           <td width="60% " style="padding-top: 40px ">Nombre Competo:</td>
                           <td style="padding-top: 40px ">{{Nombre}}</td>
                       </tr>
                       <tr >
                           <td width="60% " style="padding-top: 40px ">Numero de Identidad:</td>
                           <td style="padding-top: 40px ">{{Identidad}}</td>
                       </tr>
                   </thead>
               ...
               <br></br>
                ...
                <div>
                    ...
                    <a class="btn btn-outline-primary btn-lg btn-block " href="./Pdf/Vacaciones.php?Identidad={{Identidad}}&FechaIni={{Inicio}}&FechaFin={{Final}} ">Imprimir PDf</a>
                </div>
            </div><!-- .animated -->
        </div><!-- .content -->
        <!-- /.content -->
